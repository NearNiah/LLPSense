...
We highly recommend using Docker to set up the environment. Our code has been tested on Ubuntu 22.04.3 LTS (Python 3.10.14, CUDA 11.8).
...
cd /workspace
git clone --recursive [https://github.com/NearNiah/LLPSense](https://github.com/NearNiah/LLPSense)
cd LLPSense
...
```bibtex
@article{bae2025llpsense,
  title={A machine learning framework for predicting and modulating condition-dependent protein phase separation}, 
  author={Jangwon Bae and Minjun Kang and Donghyuk Lee and Kuk-Jin Yoon and Yongwon Jung},
  journal={bioRxiv},
  year={2025},
  url={[https://www.biorxiv.org/content/10.1101/2023.08.23.554541v1](https://www.biorxiv.org/content/10.1101/2023.08.23.554541v1)},
